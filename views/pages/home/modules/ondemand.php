...
$url = "relations?rel=variants,products&type=variant,product&linkTo=type_variant&equalTo=ondemand&startAt=0&endAt=4&orderBy=id_variant&orderMode=DESC&select=" . $select;
$method = "GET";
$fields = array();

$ondemandProducts = CurlController::request($url, $method, $fields);


if ($ondemandProducts->status == 200) {

    $ondemandProducts = $ondemandProducts->results;
} else {

    $ondemandProducts = array();
}

if (count($ondemandProducts) == 0) {
...
if (!empty($ondemandProducts)) {

    foreach ($ondemandProducts as $key => $value) {
        ...
        if (isset($_SESSION["user"])) {
            ...
            if ($favorite->status == 200) {
                ...
                $ondemandProducts[$key]->id_favorite = $favorite->results[0]->id_favorite;
            } else {

                $ondemandProducts[$key]->id_favorite = 0;
            }
        } else {
...
<div class="container-fluid bg-white">
    ...
    <div class="container">
        ...
        <div class="clearfix pt-3 pb-0 px-2">
            ...
            <h4 class="float-start text-uppercase pt-2">Artículos Cotizables</h4>

            <span class="float-end">

                <a href="/ondemand" class="btn btn-default templateColor">
