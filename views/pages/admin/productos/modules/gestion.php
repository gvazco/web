                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group pb-3">
                                        ...
                                        <input type="hidden" name="old_id_category_product"
                                            value="<?php echo base64_encode($product->id_category_product) ?>">

                                        <?php endif ?>

                                        <label for="id_category_product">Seleccionar Categoría<sup
                                        ...
                                        <select class="custom-select" name="id_category_product"
                                            id="id_category_product" onchange="changeCategory(event)" required>
                                            ...
                                            <option value="<?php echo $value->id_category ?>"
                                                <?php if (!empty($product) && $product->id_category_product == $value->id_category) : ?>
                                                selected <?php endif ?>><?php echo $value->name_category ?></option>
                                    ...
                                    <div class="form-group pb-3">
                                        ...
                                        <input type="hidden" name="old_id_subcategory_product"
                                            value="<?php echo base64_encode($product->id_subcategory_product) ?>">

                                        <?php endif ?>

                                        <label for="id_subcategory_product">Seleccionar Subcategoría<sup
                                                class="text-danger">*</sup></label>

                                        <select class="custom-select" name="id_subcategory_product"
                                            id="id_subcategory_product" required>

                                            <?php if (!empty($product)) : ?>

                                            <option value="<?php echo $product->id_subcategory_product ?>">
                                                <?php echo $product->name_subcategory ?></option>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group pb-3">
                                        ...
                                        <label for="description_product">Descripción<sup
                                                class="text-danger font-weight-bold">*</sup></label>

                                        <textarea rows="9" class="form-control mb-3"
                                            placeholder="Ingresar la descripción" id="description_product"
                                            name="description_product" onchange="validateJS(event,'complete')"
                                    ...
                                    <div class="form-group pb-3">
                                        ...
                                        <label for="keywords_product">Palabras claves<sup
                                                class="text-danger font-weight-bold">*</sup></label>

                                        <input type="text" class="form-control tags-input" data-role="tagsinput"
                                            placeholder="Ingresar las palabras claves" id="keywords_product"
                                            name="keywords_product" onchange="validateJS(event,'complete-tags')"
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group pb-3 text-center">
                                        ...
                                        <label class="pb-3 float-left">Imagen del Producto<sup
                                                class="text-danger">*</sup></label>
                                        ...
                                        <label for="image_product">
                                            ...
                                            <input type="hidden" value="<?php echo $product->image_product ?>"
                                                name="old_image_product">

                                            <img src="/views/assets/img/products/<?php echo $product->url_product ?>/<?php echo $product->image_product ?>"
                                                class="img-fluid changeImage">

                                            <?php else : ?>

                                            <img src="/views/assets/img/products/default/default-image.jpg"
                                                class="img-fluid changeImage">
                                        ...
                                        <div class="custom-file">
                                            ...
                                            <input type="file" class="custom-file-input" id="image_product"
                                                name="image_product" accept="image/*" maxSize="2000000"
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group mx-auto" style="max-width:700px">
                                        ...
                                        <label for="info_product">Información del Producto<sup
                                                class="text-danger">*</sup></label>
                        ...
                        <div class="col">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <input type="hidden" class="idVariant" name="idVariant_<?php echo ($key + 1) ?>"
                                        value="<?php echo $value->id_variant ?>">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="d-flex justify-content-between">
                                                    ...
                                                    <label for="info_product">Variante <?php echo ($key + 1) ?><sup
                                                            class="text-danger">*</sup></label>
                                            ...
                                            <div class="row row-cols-1 row-cols-md-2">
                                                ...
                                                <div class="col">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select class="custom-select"
                                                            ...
                                                            <option <?php if ($value->type_variant == "ondemand") : ?>
                                                                selected <?php endif ?> value="ondemand">Cotizables
                                                            </option>
                                                    ...
                                                    <?php if ($value->type_variant == "video") : ?>
                                                    ...
                                                    <input type="hidden" name="galleryProduct_<?php echo ($key + 1) ?>"
                                                        class="galleryProduct_<?php echo ($key + 1) ?>"
                                                        style="display:none">
                                                    ...
                                                    <div class="dropzone dropzone_<?php echo ($key + 1) ?> mb-3">
                                                        ...
                                                        <div class="dz-preview dz-file-preview">
                                                            ...
                                                            <div class="dz-image">
                                                                ...
                                                                <img class="img-fluid"
                                                                    src="<?php echo "/views/assets/img/products/" . $product->url_product . "/" . $item ?>">
                                                    ...
                                                    <input type="hidden"
                                                        name="galleryOldProduct_<?php echo ($key + 1) ?>"
                                                        class="galleryOldProduct_<?php echo ($key + 1) ?>"
                                                        value='<?php echo $value->media_variant ?>'>

                                                    <input type="hidden"
                                                        name="deleteGalleryProduct_<?php echo ($key + 1) ?>"
                                                        class="deleteGalleryProduct_<?php echo ($key + 1) ?>"
                                                        value='[]'>
                                                ...
                                                <div class="col">
                                                    ...
                                                    <div
                                                        class="input-group mb-3  inputWhatsapp_<?php echo ($key + 1) ?>">
                                                        ...
                                                        <input type="text" class="form-control"
                                                            name="whatsapp_variant_<?php echo ($key + 1) ?>"
                                                            placeholder="Enlace a variante en WhatsApp"
                                                            value="<?php echo $value->whatsapp_variant ?>">
                                                    ...
                                                    <div class="input-group mb-3 inputCost_<?php echo ($key + 1) ?>">
                                                    ...
                                                    <div class="input-group mb-3 inputPrice_<?php echo ($key + 1) ?>">
                                                    ...
                                                    <div class="input-group mb-3 inputOffer_<?php echo ($key + 1) ?>">
                                                    ...
                                                    <div
                                                        class="input-group mb-3 inputEndOffer_<?php echo ($key + 1) ?>">
                                                    ...
                                                    <div class="input-group mb-3 inputStock_<?php echo ($key + 1) ?>">
                                    ...
                                    <div class="row row-cols-1 row-cols-md-2">
                                        ...
                                        <div class="col">
                                            ...
                                            <div class="input-group mb-3 inputVideo_1" style="display:none">
                                                ...
                                                <input type="text" class="form-control" name="videoProduct_1"
                                                    placeholder="Ingresa la URL de YouTube"
                                        ...
                                        <div class="col">
                                            ...
                                            <!--=====================================
												Whatsapp de la variante
												======================================-->

                                            <div class="input-group mb-3 inputWhatsapp_1" style="display:none">

                                                <span class="input-group-text">
                                                    <i class="fas fa-clipboard-list"></i>
                                                </span>

                                                <input type="text" class="form-control" name="whatsapp_variant_1"
                                                    placeholder="Enlace a variante en Whatsapp">
                                            ...
                                            <div class="input-group mb-3 inputCost_1">
                                            ...
                                            <div class="input-group mb-3 inputPrice_1">
                                            ...
                                            <div class="input-group mb-3 inputOffer_1">
                                            ...
                                            <div class="input-group mb-3 inputEndOffer_1">
                                            ...
                                            <div class="input-group mb-3 inputStock_1">
                                            ...
                                            <div class="card">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <p class="text-left text-success small mb-1">
                                                        <?php echo $path ?><span
                                                            class="metaURL"><?php if (!empty($product)) : ?><?php echo $product->url_product ?><?php else : ?>lorem<?php endif ?></span>
                                                    </p>
