    ...
    <div class="container">
        ...
        <div class="card">
            ...
            <div class="card-header">
                ...
                <h3 class="card-title">
                    <a href="/admin/publicategorias/gestion"
                        class="btn bg-default templateColor py-2 px-3 btn-sm rounded-pill">Agregar Categoría</a>
                </h3>
            ...
            <div class="card-body">
                ...
                <table id="tables" class="table table-bordered table-striped publicategoriesTable">
                    ...
                    <thead>
                        <tr>
                            ...
                            <th>Publicaciones vinculadas</th>
                            <th>Visitas</th>
                            <th>Último cambio</th>
                            <th>Acciones</th>
                        </tr>
