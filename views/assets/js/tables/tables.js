...
/*=============================================
Tabla para publicategorias
=============================================*/

if ($(".publicategoriesTable").length > 0) {
  var url = "/ajax/data-publicategories.ajax.php";

  var columns = [
    { data: "id_publicategory" },
    { data: "status_publicategory" },
    { data: "name_publicategory" },
    { data: "url_publicategory" },
    { data: "image_publicategory" },
    { data: "description_publicategory" },
    { data: "keywords_publicategory" },
    { data: "publisubcategories_publicategory" },
    { data: "publications_publicategory" },
    { data: "views_publicategory" },
    { data: "date_updated_publicategory" },
    { data: "actions", orderable: false, searchable: false },
  ];
...
/*=============================================
Tabla para publisubcategorias
=============================================*/

if ($(".publisubcategoriesTable").length > 0) {
  var url = "/ajax/data-publisubcategories.ajax.php";

  var columns = [
    { data: "id_publisubcategory" },
    { data: "status_publisubcategory" },
    { data: "name_publisubcategory" },
    { data: "url_publisubcategory" },
...
if ($(".publicationsTable").length > 0) {
  var url = "/ajax/data-publications.ajax.php";

  var columns = [
    { data: "id_publication" },
    { data: "status_publication" },
    { data: "name_publication" },
    { data: "url_publication" },
    { data: "image_publication" },
    { data: "description_publication" },
    { data: "keywords_publication" },
    { data: "name_publicategory" },
    { data: "name_publisubcategory" },
    { data: "views_publication" },
    { data: "date_updated_publication" },
    { data: "actions", orderable: false, searchable: false },
  ];
