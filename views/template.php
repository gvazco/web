...
<head>
    ...
    <link rel="stylesheet" href="<?php echo $path ?>views/assets/css/publications/publications.css">
    ...
    !empty($routesArray[1]) && $routesArray[1] == "publicaciones" ||
...
<body class="hold-transition sidebar-collapse layout-top-nav">
  ...
  ?>
    ...
    <script src="<?php echo $path ?>views/assets/js/publications/publications.js"></script>
