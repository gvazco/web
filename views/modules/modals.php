    ...
    <div class="modal-dialog modal-md modal-dialog-centered">
        ...
        <div class="modal-content">
            ...
            <div class="modal-header templateColor text-uppercase"
                ...
                Registro
                <button type="button" class="btn border-0 text-white" data-bs-dismiss="modal"
          ...
          ======================================-->
                    ...
                    <div class="col-sm-6 col-xs-12 text-center p-0 rounded-0">
                        ...
                        <a
                            href="<?php echo $path ?>facebook?urlRedirect=<?php echo TemplateController::urlRedirect() ?>">
        ...
        ======================================-->
                ...
                <form method="post" class="needs-validation" novalidate>
                    ...
                    <div class="input-group pb-3">
                        ...
                        <input type="text" class="form-control" name="name_user" placeholder="Nombre Completo"
                    ...
                    <div class="input-group pb-3">
                        ...
                        <input type="email" class="form-control" name="email_user" placeholder="Correo Eletrónico"
                            onchange="validateDataRepeat(event,'email')" required>
                    ...
                    <div class="input-group pb-3">
                        ...
                        <input type="password" class="form-control" name="password_user" placeholder="Contraseña"
          ...
          ?>
            ...
            <div class="modal-footer" style="justify-content: center !important;">
                ...
                <div>¿Ya tienes una cuenta registrada?
                    <a href="#login" class="ml-1 btn btn-dark btn-sm text-white" data-bs-toggle="modal"
                        style="color:white !important">Ingresar</a>
                </div>
        ...
        ======================================-->
                ...
                <form method="post" class="needs-validation" novalidate>
                    ...
                    <div class="input-group pb-3">
                        ...
                        <input type="email" class="form-control" name="login_email_user" placeholder="Correo Eletrónico"
                    ...
                    <div class="input-group pb-3">
                        ...
                        <input type="password" class="form-control" name="login_password_user" placeholder="Contraseña"
                            onchange="validateJS(event,'password')" required>
          ...
          ?>
            ...
            <div class="modal-footer" style="justify-content: center !important;">
                ...
                <div>¿No tienes una cuenta?
                    <a href="#register" class="ml-1 btn btn-dark btn-sm text-white" data-bs-toggle="modal"
                        style="color:white !important">Crear Cuenta</a>
                </div>
            ...
            <div class="modal-body">
                ...
                <form method="post">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input onchange="validateJS(event,'email')" type="email" class="form-control"
                            placeholder="Email" name="resetPassword" required>
