...
$select = "id_publicategory,name_publicategory,url_publicategory,icon_publicategory";
$url = "publicategories?select=" . $select;
$method = "GET";
$fields = array();

$dataPublicategories = CurlController::request($url, $method, $fields);
        ...
        <div class="col-12 col-lg-7 col-xl-8 mt-1 px-3 px-lg-0">
            ...
            <div class="dropdown px-1 float-start templateColor">
                ...
                <a id="dropdownSubMenu1" href="#" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"
                    ...
                    <span class="d-lg-block d-none text-uppercase">Categorías<i
                            class="ps-lg-2 fas fa-th-list"></i></span>
                    <span class="d-lg-none d-block"><i class="fas fa-th-list"></i></span>

                </a>

                <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
                    <h6 style="margin:0.5rem  1rem;" class="text-uppercase">Productos</h6>
                    ...
                    <li class="dropdown-submenu dropdown-hover">
                        ...
                        <a id="dropdownSubMenu<?php echo $key ?>" href="/<?php echo $value->url_category ?>"
                            role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"
                            class="dropdown-item dropdown-toggle"
                            onclick="redirect('/<?php echo $value->url_category ?>')">

                            <i class="<?php echo $value->icon_category ?> pe-2 fa-xs"></i>
                        ...
                        <ul class="border-0 shadow py-3 ps-3 d-block d-lg-none">
                            ...
                            <li>
                                <a tabindex="-1" href="/<?php echo $item->url_subcategory ?>"
                                    class="dropdown-item"><?php echo $item->name_subcategory ?></a>
                            </li>
                    ...
                    <h6 style="margin:0.5rem  1rem;" class="text-uppercase">Archivo</h6>
                    ...
                    <li class="dropdown-submenu dropdown-hover">
                        ...
                        <a id="dropdownSubMenu<?php echo $key ?>" href="/<?php echo $plusvalue->url_publicategory ?>"
                            role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"
                            class="dropdown-item dropdown-toggle"
                            onclick="redirect('/<?php echo $plusvalue->url_publicategory ?>')">

                            <i class="<?php echo $plusvalue->icon_publicategory ?> pe-2 fa-xs"></i>
